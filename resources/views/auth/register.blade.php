                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="type" id="type">
                                    <option value="" disabled>Choose from the following</option>
                                    <option value="teacher" {{ old('teacher') ? 'selected' : '' }}>Teacher</option>
                                    <option value="student" {{ old('student') ? 'selected' : '' }}>Student</option>
                                </select>
                                @error('type')
